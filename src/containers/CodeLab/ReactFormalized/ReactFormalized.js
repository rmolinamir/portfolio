...
// CSS
import classes from './ReactFormalized.module.css'
// JSX
...
import {
  ...
  Provider,
  defaultTheme
  // darkTheme // Using a custom darkTheme on this website.
...
const reactFormalized = (props) => {
  ...
  const changeThemeHandler = () => {
    if (props.themeContext && props.themeContext.toggleTheme) {
      props.themeContext.toggleTheme()
    }
  }

  useEffect(() => {
    if (props.themeContext && props.themeContext.theme) {
      if (theme === 'dark') {
        props.inputContext.setTheme(darkTheme)
      } else {
