  ...
  return (
    <Container id="introduction">
      ...
      <P>
        ...
        years in a variety of technologies and languages, including Python, JavaScript (andTypeScript), C++, and
      ...
      <br />
      <P>
        I have invested a great deal of time and energy learning and increasing my knowledge to gain in-depth understanding
